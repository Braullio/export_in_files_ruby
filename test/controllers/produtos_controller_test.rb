...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { name: @produto.name, quantity: @produto.quantity } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { name: @produto.name, quantity: @produto.quantity } }
